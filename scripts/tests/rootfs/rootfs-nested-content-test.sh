...
cp "$nested" "$work/outer-tree/guest/rootfs-x86_64-busybox-0.img"
cp "$nested" "$work/outer-tree/guest/rootfs-x86_64-busybox-1.img"
...
cp "$bad_nested" "$bad_tree/guest/rootfs-x86_64-busybox-0.img"
cp "$bad_nested" "$bad_tree/guest/rootfs-x86_64-busybox-1.img"
...
cp "$recursive_nested" "$recursive_tree/guest/rootfs-x86_64-busybox-0.img"
cp "$recursive_nested" "$recursive_tree/guest/rootfs-x86_64-busybox-1.img"
