...
usage() {
    ...
    printf '  * ext4 outputs contain two independent guest rootfs images with identical initial contents.\n'
    printf '  * Guest paths: /guest/rootfs-<arch>-<type>.img and /guest/rootfs-<arch>-<type>-2.img.\n'
